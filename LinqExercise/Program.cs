...
namespace LinqExercise
{
    class Program
    {
        ...
        private static List<Employee> CreateEmployees()
        {
            ...
            employees.Add(new Employee("Paul", "Little", 45, 22));
            employees.Add(new Employee("LaShanda", "Castille", 22, 2));
            employees.Add(new Employee("Peter", "Apostle", 33, 5));
            employees.Add(new Employee("Matthew", "Modine", 15, 1));
            employees.Add(new Employee("Mark", "Watkins", 67, 35));
            employees.Add(new Employee("Luke", "Romo", 37, 7));
            employees.Add(new Employee("John", "Mahomes", 21, 3));
            employees.Add(new Employee("Mary", "Kelce", 28, 10));
            employees.Add(new Employee("Madeline", "Hartman", 34, 6));
            employees.Add(new Employee("Cortez", "Hill", 33, 9));
